...
np_tl_jungle = NeopixelSegment(neopixels, 0, 1) 
...
np_door = NeopixelSegment(neopixels, 39, 1)
np_tl_1 = NeopixelSegment(neopixels, 42, 1)
np_elevator = NeopixelSegment(neopixels, 64, 1)

np_fl_1_1 = Neopixels(neopixels, 8, 1)
np_fl_1_2 = Neopixels(neopixels, 11, 1)
np_fl_1_3 = Neopixels(neopixels, 27, 1)
np_fl_2_1 = Neopixels(neopixels, 29, 1)
